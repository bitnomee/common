...
2. Make your changes in the `charts/common/` directory
3. Test your changes locally
4. Submit a pull request

## Chart Structure

This repository contains a single Helm chart located in `charts/common/`. The chart follows the same structure and conventions as the original Bitnami Charts.
